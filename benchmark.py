...
for _ in tqdm.tqdm(range(number_games_to_test)):
	...
	while True:
		checker_model_object.ia_move(model="random", to_maximise=None, depth=None, cost_number=None)
		...
		checker_model_object.ia_move(model="minimax_montecarlo", to_maximise=True, depth=None, cost_number=1000)
		game_state = checker_model_object.check_game_state()
		if game_state == "draw_game":
			break
